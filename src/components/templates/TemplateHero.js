...
const TemplateHero = () => {
  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center bg-gradient-to-br from-zinc-200 to-lime-50">
      ...
      <motion.p
        ...
        whileHover={{ scale: 1 }}
        whileTap={{ scale: 0.95 }}
        className="mt-12 px-6 py-3 text-black/90  rounded-full shadow-md hover:text-primary/90 transition-colors flex items-center space-x-2"
      >
