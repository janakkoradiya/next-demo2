    ...
    <div className="flex flex-col items-center justify-center h-fit w-full relative mt-7">
      {[0, 1, 2].map((index) => (
        <motion.div
          ...
          animate="visible"
        >
          <div className="absolute top-0 left-0 w-1/2 h-full bg-[#734c56] transform skew-y-[30deg]"></div>
          <div className="absolute top-0 right-0 w-1/2 h-full bg-[#734c56] transform skew-y-[-30deg]"></div>
          <div className="absolute top-0 left-0 w-1/2 h-full bg-[#734c56] transform skew-y-[30deg]"></div>
          <div className="absolute top-0 right-0 w-1/2 h-full bg-[#734c56] transform skew-y-[-30deg]"></div>
        </motion.div>
      ))}
...
export default ScrollDownArrow2;
